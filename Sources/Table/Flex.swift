                ...
                if children.isEmpty {
                    ...
                    YGNodeSetMeasureFunc(node) { node, width, widthMode, height, heightMode in
                        ...
                        let constrainedSize = CGSize(
                            width: widthMode == YGMeasureModeUndefined ? .greatestFiniteMagnitude : CGFloat(width),
                            height: heightMode == YGMeasureModeUndefined ? .greatestFiniteMagnitude : CGFloat(height)
                        )
