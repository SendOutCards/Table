...
class FlexState {
    ...
    func sizeThatFits(_ size: CGSize) -> CGSize {
        YGNodeCalculateLayout(node, Float(size.width), Float(size.height), YGDirectionInherit)
        return CGSize(
...
extension UIView {
    ...
    var direction: YGDirection {
        if #available(iOS 10.0, tvOS 10.0, *) {
            ...
            case .leftToRight: return YGDirectionLTR
            case .rightToLeft: return YGDirectionRTL
            @unknown default:
